					 ...
					 Plan *inner_plan)
{
	...
	List	   *hashclauses;
	HashJoin   *join_plan;
	Hash	   *inner_hash_plan; //SymmetrichashJoinMade
    Hash       *outer_hash_plan; //SymmetrichashJoinMade
    ...
    outer_hash_plan = make_hash(outer_plan); //SymmetrichashJoinMade
	join_plan = make_hashjoin(tlist,
							  joinclauses,
							  otherclauses,
							  hashclauses,
							  (Plan *) outer_hash_plan, //SymmetrichashJoinMade
							  (Plan *) inner_hash_plan, //SymmetrichashJoinMade
							  best_path->jpath.jointype);
