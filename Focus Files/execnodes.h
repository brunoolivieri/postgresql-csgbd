...
typedef struct PlanState
{
    ...
    TupleTableSlot *ps_InnerTupleSlot; //SymmetricHashJoinsMade
...
//SymmetricHashJoinsMade : Modified to support keeping track of both inner and outer hash tables
/* ----------------
...
typedef struct HashJoinState//SymmetrichashJoinMade
{
	JoinState	js;				/* its first field is NodeTag */
	List	   *hashclauses;	/* list of ExprState nodes */
	
    HashJoinTable hj_InnerHashTable; //SymmetrichashJoinMade
    HashJoinTable hj_OuterHashTable; //SymmetrichashJoinMade
	
    uint32		hj_InnerCurHashValue; //SymmetrichashJoinMade
    uint32		hj_OuterCurHashValue; //SymmetrichashJoinMade
	
    int			hj_InnerCurBucketNo; //SymmetrichashJoinMade
    int			hj_OuterCurBucketNo; //SymmetrichashJoinMade
	
    HashJoinTuple hj_InnerCurTuple; //SymmetrichashJoinMade
    HashJoinTuple hj_OuterCurTuple; //SymmetrichashJoinMade
    ...
    TupleTableSlot *hj_InnerTupleSlot; //SymmetrichashJoinMade
    TupleTableSlot *hj_OuterTupleSlot;
	
	TupleTableSlot *hj_InnerHashTupleSlot; //SymmetrichashJoinMade
    TupleTableSlot *hj_OuterHashTupleSlot; //SymmetrichashJoinMade
	
    TupleTableSlot *hj_NullInnerTupleSlot;
	
    TupleTableSlot *hj_FirstInnerTupleSlot; //SymmetrichashJoinMade
    TupleTableSlot *hj_FirstOuterTupleSlot;
    
    bool        hj_innerExhausted; //SymmetrichashJoinMade
    bool        hj_outerExhausted; //SymmetrichashJoinMade
    
    bool        hj_NeedNewInner; //SymmetrichashJoinMade
    bool        hj_NeedNewOuter;
    
    bool        hj_MatchedOuter;
    
    bool        hj_InnerNotEmpty; //SymmetrichashJoinMade
    bool        hj_OuterNotEmpty;

    bool        hj_fetchingFromInner; //SymmetrichashJoinMade true if we fetched tuple from inner relation
    
    int         hj_foundByProbingInner; //SymmetrichashJoinMade number of tuples found by probing inner relation
    int         hj_foundByProbingOuter; //SymmetrichashJoinMade number of tuples found by probing outer relation
} HashJoinState;
